...
import { logout } from "../components/api/auth" // Import the logout function from auth.js


const Header = ({ email, onMenuClick, isSidebarOpen }) => {
  const navigate = useNavigate();

  const handlelogout = () => {
    logout(navigate); // Call the imported logout function with navigate
  };
