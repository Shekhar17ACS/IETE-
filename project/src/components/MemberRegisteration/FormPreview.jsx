...
const FormPreview = ({ nextStep, prevStep }) => {
  ...
  const processQualifications = () => {
    ...
    if (
      formData.personalDetails.otherQualifications &&
      Array.isArray(formData.personalDetails.otherQualifications)
    ) {
      formData.personalDetails.otherQualifications.forEach((qual, index) => {
        processedQuals.push({
          level: `Other Qualification ${index + 1}`,
          degree:
            degreeMapping[qual.qualification_type] || qual.qualification_type,
          stream:
            streamMapping[qual.qualification_branch] ||
    ...
    if (formData.qualifications && Array.isArray(formData.qualifications)) {
      formData.qualifications.forEach((qual, index) => {
        processedQuals.push({
          ...
          degree:
            degreeMapping[qual.qualification_type] ||
    ...
    return (
      <div className="flex flex-col items-center justify-center  text-center">
        ...
        <p className="text-red-600 text-lg font-medium">
          Membership application is not yet approved by required number of
          proposers.
        </p>
      </div>
    );
      ...
      <div className="mb-6 sm:mb-8">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-black p-2 w-1/4">
                  {titleMapping[formData.personalDetails.title] ||
                ...
                <td className="border border-black p-2 w-1/4">
                  {formData.personalDetails.name || "N/A"}
                </td>
              </tr>
              <tr>
                ...
                <td className="border border-black p-2">
                  {formData.personalDetails.middle_name || "N/A"}
                </td>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                  Last Name
                </td>
                <td className="border border-black p-2">
                  {formData.personalDetails.last_name || "N/A"}
                </td>
              </tr>
              <tr>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                ...
                <td className="border border-black p-2">
                  {formData.personalDetails.father_name || "N/A"}
                </td>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                  Mother's Name
                </td>
                <td className="border border-black p-2">
                  {formData.personalDetails.mother_name || "N/A"}
                </td>
              </tr>
              <tr>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                ...
                <td className="border border-black p-2">
                  {formData.personalDetails.spouse_name || "N/A"}
                </td>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                  Date of Birth
                </td>
                <td className="border border-black p-2">
                  {formData.personalDetails.date_of_birth || "N/A"}
                </td>
              </tr>
              <tr>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                ...
                <td className="border border-black p-2">
                  {formData.personalDetails.gender || "N/A"}
                </td>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                  Indian Resident
                </td>
                <td className="border border-black p-2">
                  {formData.personalDetails.from_india ? "Yes" : "No"}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="lg:hidden space-y-3">
          {[
            ...
            {
              label: "First Name",
              value: formData.personalDetails.name || "N/A",
            },
            {
              label: "Middle Name",
              value: formData.personalDetails.middle_name || "N/A",
            },
            {
              label: "Last Name",
              value: formData.personalDetails.last_name || "N/A",
            },
            {
              label: "Father's Name",
              value: formData.personalDetails.father_name || "N/A",
            },
            {
              label: "Mother's Name",
              value: formData.personalDetails.mother_name || "N/A",
            },
            {
              label: "Spouse Name",
              value: formData.personalDetails.spouse_name || "N/A",
            },
            {
              label: "Date of Birth",
              value: formData.personalDetails.date_of_birth || "N/A",
            },
            {
              label: "Gender",
              value: formData.personalDetails.gender || "N/A",
            },
            {
              label: "Indian Resident",
              value: formData.personalDetails.from_india ? "Yes" : "No",
            },
          ].map((item, index) => (
            <div key={index} className="border border-black">
              ...
              <div className="p-2 text-xs sm:text-sm break-words">
                {item.value}
              </div>
            </div>
          ))}
      ...
      <div className="mb-6 sm:mb-8">
          ...
          <table className="w-full border-collapse border border-black text-sm">
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-black p-2">
                  {formData.personalDetails.mobile_number || "N/A"}
                </td>
                <td className="border border-black p-2 font-semibold bg-gray-100 w-1/4">
                  Landline Number
                </td>
                <td className="border border-black p-2">
                  {formData.personalDetails.landline_no || "N/A"}
                </td>
              </tr>
              <tr>
                <td className="border border-black p-2 font-semibold bg-gray-100">
              ...
              <tr>
                ...
                <td className="border border-black p-2">
                  {formData.personalDetails.country || "N/A"}
                </td>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                  State
                </td>
                <td className="border border-black p-2">
                  {formData.personalDetails.state || "N/A"}
                </td>
              </tr>
              <tr>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                ...
                <td className="border border-black p-2">
                  {formData.personalDetails.city || "N/A"}
                </td>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                  Pincode
                </td>
                <td className="border border-black p-2">
                  {formData.personalDetails.pincode || "N/A"}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="border border-black p-2">
                  {formData.personalDetails.centre_name || "N/A"}
                </td>
                <td className="border border-black p-2 font-semibold bg-gray-100">
                  Sub Centre
                </td>
                <td className="border border-black p-2">
                  {formData.personalDetails.sub_centre_name || "N/A"}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="lg:hidden space-y-3">
          {[
            {
              label: "Email Address",
              value: formData.personalDetails.email || "N/A",
            },
            {
              label: "Mobile Number",
              value: formData.personalDetails.mobile_number || "N/A",
            },
            {
              label: "Landline Number",
              value: formData.personalDetails.landline_no || "N/A",
            },
            {
              label: "Address Line 1",
              value: formData.personalDetails.address1 || "N/A",
            },
            {
              label: "Address Line 2",
              value: formData.personalDetails.address2 || "N/A",
            },
            {
              label: "Address Line 3",
              value: formData.personalDetails.address3 || "N/A",
            },
            {
              label: "Country",
              value: formData.personalDetails.country || "N/A",
            },
            { label: "State", value: formData.personalDetails.state || "N/A" },
            { label: "City", value: formData.personalDetails.city || "N/A" },
            {
              label: "Pincode",
              value: formData.personalDetails.pincode || "N/A",
            },
            {
              label: "Centre",
              value: formData.personalDetails.centre_name || "N/A",
            },
            {
              label: "Sub Centre",
              value: formData.personalDetails.sub_centre_name || "N/A",
            },
          ].map((item, index) => (
            <div key={index} className="border border-black">
              <div className="bg-gray-100 border-b border-black p-2 font-semibold text-xs sm:text-sm">
                  ...
                  <div className="p-3 space-y-2">
                    {[
                      ...
                      <div key={idx} className="flex flex-col sm:flex-row">
                        <span className="font-semibold text-xs sm:text-sm sm:w-1/3">
                          {item.label}:
                        </span>
                ...
                <div key={index} className="border border-black">
                  ...
                  <div className="p-3 space-y-2">
                    {[
                      ...
                      {
                        label: "Organization",
                        value: exp.organization_name || "N/A",
                      },
                      {
                        label: "Employee Type",
                        value: exp.employee_type || "N/A",
                      },
                      ...
                      {
                        label: "Experience",
                        value: exp.total_experience || "N/A",
                      },
                    ].map((item, idx) => (
                      <div key={idx} className="flex flex-col sm:flex-row">
                        <span className="font-semibold text-xs sm:text-sm sm:w-1/3">
                ...
                <tbody>
                  {formData.proposers.map((proposer, index) => (
                    <tr key={index}>
                      ...
                      <td className="border border-black p-2">
                        {proposer.membership_no || "N/A"}
                      </td>
                      <td className="border border-black p-2">
                        {proposer.email || "N/A"}
                      </td>
                      <td className="border border-black p-2">
                        {proposer.mobile_no || "N/A"}
                      </td>
                    </tr>
                  ))}
                </tbody>
                ...
                <div key={index} className="border border-black">
                  ...
                  <div className="p-3 space-y-2">
                    {[
                      ...
                      {
                        label: "Membership No.",
                        value: proposer.membership_no || "N/A",
                      },
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-black p-2 w-1/2">
                  {formData.exposure === "True"
                    ? "Yes"
                    : formData.exposure === "False"
                    ? "No"
                    : "N/A"}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td className="border border-black p-2">
                  {formData.area_of_specialization || "N/A"}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="lg:hidden space-y-3">
          {[
            ...
            },
            {
              ...
              value: formData.area_of_specialization || "N/A",
            },
          ].map((item, index) => (
            <div key={index} className="border border-black">
              <div className="bg-gray-100 border-b border-black p-2 font-semibold text-xs sm:text-sm">
            ...
            <tbody>
              {[
                ...
                <tr key={key}>
                  ...
                  <td className="border border-black p-2">
                    {formData.files[key]
                      ? formData.files[key].name || "File uploaded"
                      : "N/A"}
                  </td>
                </tr>
              ))}
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="border border-black p-3 sm:p-4">
          <p className="text-xs sm:text-sm text-justify mb-4">
            ...
            form is true and accurate to the best of my knowledge. I understand
            that any false information may result in the rejection of my
            application or cancellation of membership. I agree to abide by the
            rules and regulations of The Institution of Electronics and
          ...
          <div className="flex items-start space-x-2 mt-4">
            ...
            <label htmlFor="consent" className="text-xs sm:text-sm font-medium">
              I agree to the above declaration and give my consent for
