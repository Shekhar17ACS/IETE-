...
const MultiStepForm = () => {
  ...
  const [completedSteps, setCompletedSteps] = useState(
    () => JSON.parse(sessionStorage.getItem("completedSteps")) || []
  );
  ...
  const handleNextStep = () => {
    ...
    setStep(nextStep);
    const nextRoute =
      nextStep <= 7 ? `/admin/eligible/step${nextStep}` : "/admin/eligible";
    navigate(nextRoute);
  };
  ...
  const handlePrevStep = () => {
    ...
    setStep(prevStep);
    const prevRoute =
      prevStep === 1 ? "/admin/eligible" : `/admin/eligible/step${prevStep}`;
    navigate(prevRoute);
  };
  ...
  const handleStepClick = (stepNumber) => {
    const targetRoute =
      stepNumber === 1
        ? "/admin/eligible/step1"
        : `/admin/eligible/step${stepNumber}`;
        ...
        <div className="text-center space-y-6">
          <div className="space-y-3">
            <p className="text-lg text-gray-700 leading-relaxed">
              Thank you for submitting your application! We've received all your
              information and our team is now reviewing your submission.
            </p>
            <p className="text-gray-600">
              You'll receive updates throughout the review process to keep you
              informed of your application status.
            </p>
          </div>
            ...
            <div className="space-y-3 text-sm text-gray-700">
              <div className="flex items-start gap-3">
                ...
                <p className="text-left">
                  ...
                  message with your application reference number
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-left">
                  <strong>Use our tracker</strong> - Monitor your application
                  progress in real-time using your reference number
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-left">
                  <strong>Stay updated</strong> - We'll notify you via email at
